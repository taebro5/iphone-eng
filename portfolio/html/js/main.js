( function( $ ) {
    ...
    $( '.vertical-counter' ).each( function () {
        var _this           = $( this );
            ...
            if(counterValue = '1268' ){
                var counterValue2 = Math.floor(Math.random()*(1300-1000+1)) + 1000;
                var str1 = '';
                var str2 = '';
                var counterValue = str1.concat(counterValue2,str2);
          };
          //alert(counterValue);
          //alert(JSON.stringify(counterValue));
      var individualValue = counterValue.toString().split( '' ),
